...
namespace OverRelaxation
{
    ...
    double xTotalEps, double yTotalEps, double epsMax, int nIters, double rmax, double r2, double rmax2 = 0.0, double r22 = 0.0)
        {
            ...
            labelr2.Text = "Евклидова Норма невязки для v = " + r2.ToString();
            if (!istest)
            {
                labelrmax2.Text = "Норма невязки для v2 = " + rmax2.ToString();
                labelr22.Text = "Евклидова Норма невязки для v2 = " + r22.ToString();
            }
            else
            {
                labelrmax2.Text = " ";
